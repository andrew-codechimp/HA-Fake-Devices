...
You can add the device name, manufacturer, model and serial number, plus model id, hardware, firmware and a URL as optional additional fields. You can use these to store any short piece of text you want.
