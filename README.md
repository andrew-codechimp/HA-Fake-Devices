...
You can add the device name, manufacturer, model and serial number. No entities are created, it's just a device placeholder for using with helpers where you have the option to add to a device.
